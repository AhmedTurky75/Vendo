...
// Add CORS configuration for Angular Admin Portal (shell-app on port 4200)
...
{
    options.Cookie.Name = "__Host-admin-bff";
    options.Cookie.SameSite = SameSiteMode.Strict;
    options.Cookie.HttpOnly = true;
    options.Cookie.SecurePolicy = CookieSecurePolicy.Always;

    // Session timeout - 15 minutes idle for admin portal
